...
@section('contentheader_title','Mis alumnos online')
    ...
    <div class="col-xs-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Registros de alumnos online</h3>
        </div>
				<div class="box-body">
                ...
                <table id="dataTables" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" style="display:none;">
                  <thead>
                    <tr>
                      ...
                      <th data-priority="5">Inicio de plataforma</th>
                      <th data-priority="6">Cierre de plataforma</th>
                  ...
                  <tbody>
                    ...
                    <td>{{$voucher->VINICIO}}</td>
										<td>{{\Carbon\Carbon::parse($voucher->VINICIO)->addDays(180)->toDateString()}}</td>
