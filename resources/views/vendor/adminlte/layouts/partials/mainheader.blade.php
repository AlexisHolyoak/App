...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo" style="text-decoration:none;">
        ...
        <span class="logo-mini"><img src="{{asset('img/mini-logo.png')}}" class="img-responsive" alt=""> </span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img src="{{asset('img/plain-logo.png')}}" alt=""> </span>
    </a>
    <!-- Header Navbar -->
