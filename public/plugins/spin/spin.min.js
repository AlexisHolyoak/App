...
this.el=undefined}
return this};return Spinner}());export{Spinner};function getAdvancePercentage(msSinceLastFrame,roundsPerSecond){return msSinceLastFrame/1000*roundsPerSecond}
...
function drawLines(el,opts){var borderRadius=(Math.round(opts.corners*opts.width*500)/1000)+'px';var shadow='none';if(opts.shadow===!0){shadow='0 2px 4px #000'}
